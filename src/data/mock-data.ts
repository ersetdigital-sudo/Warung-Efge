...
export const products: Product[] = [
  {
    ...
    minStock: 10,
    unit: 'Karung',
    unitConversions: [{ fromUnit: 'Karung', toUnit: 'Kg', conversionRate: 5 }],
  ...
  },
  {
    ...
    minStock: 10,
    unit: 'Botol',
    unitConversions: [{ fromUnit: 'Dus', toUnit: 'Botol', conversionRate: 6 }],
    createdAt: '2024-01-15',
    updatedAt: '2024-03-20',
  },
  {
    ...
    minStock: 15,
    unit: 'Kg',
    unitConversions: [{ fromUnit: 'Karung', toUnit: 'Kg', conversionRate: 50 }],
    createdAt: '2024-01-15',
    updatedAt: '2024-03-20',
  },
  {
    ...
    unit: 'Pcs',
    unitConversions: [
      { fromUnit: 'Dus', toUnit: 'Pcs', conversionRate: 40 },
      { fromUnit: 'Pak', toUnit: 'Pcs', conversionRate: 5 },
    ],
    createdAt: '2024-01-15',
    updatedAt: '2024-03-20',
  },
  {
    ...
    minStock: 10,
    unit: 'Bungkus',
    unitConversions: [{ fromUnit: 'Dus', toUnit: 'Bungkus', conversionRate: 20 }],
    createdAt: '2024-01-15',
    updatedAt: '2024-03-20',
  },
  {
    ...
    minStock: 10,
    unit: 'Pcs',
    unitConversions: [{ fromUnit: 'Dus', toUnit: 'Pcs', conversionRate: 12 }],
    createdAt: '2024-01-15',
    updatedAt: '2024-03-20',
  },
  {
    ...
    minStock: 8,
    unit: 'Botol',
    unitConversions: [{ fromUnit: 'Dus', toUnit: 'Botol', conversionRate: 12 }],
    createdAt: '2024-01-15',
    updatedAt: '2024-03-20',
  },
  {
    id: '8',
    name: 'Susu Indomilk 1L',
    sku: 'SSU-001',
    ...
    minStock: 10,
    unit: 'Kotak',
    unitConversions: [{ fromUnit: 'Dus', toUnit: 'Kotak', conversionRate: 12 }],
    createdAt: '2024-01-15',
    updatedAt: '2024-03-20',
  },
  {
    ...
    minStock: 15,
    unit: 'Bungkus',
    unitConversions: [{ fromUnit: 'Dus', toUnit: 'Bungkus', conversionRate: 24 }],
    createdAt: '2024-01-15',
    updatedAt: '2024-03-20',
  },
  {
    ...
    minStock: 10,
    unit: 'Botol',
    unitConversions: [{ fromUnit: 'Dus', toUnit: 'Botol', conversionRate: 24 }],
    createdAt: '2024-01-15',
    updatedAt: '2024-03-20',
  },
];
...
export const transactions: Transaction[] = [
  {
    id: 'TRX-001',
    items: [
      { productId: '4', productName: 'Indomie Goreng', quantity: 5, unit: 'Pcs', price: 3500, subtotal: 17500 },
      { productId: '3', productName: 'Gula Pasir 1kg', quantity: 2, unit: 'Kg', price: 16000, subtotal: 32000 },
    ],
    subtotal: 49500,
    discount: 0,
    total: 49500,
  ...
  },
  {
    id: 'TRX-002',
    items: [
      { productId: '1', productName: 'Beras Premium 5kg', quantity: 1, unit: 'Karung', price: 68000, subtotal: 68000 },
      { productId: '2', productName: 'Minyak Goreng Bimoli 2L', quantity: 2, unit: 'Botol', price: 32000, subtotal: 64000 },
    ],
    subtotal: 132000,
    discount: 2000,
    total: 130000,
  ...
  },
  {
    id: 'TRX-003',
    items: [
      { productId: '5', productName: 'Kopi Kapal Api Special 165g', quantity: 3, unit: 'Bungkus', price: 12000, subtotal: 36000 },
      { productId: '6', productName: 'Detergen Rinso 800g', quantity: 1, unit: 'Pcs', price: 15000, subtotal: 15000 },
      { productId: '9', productName: 'Garam Halus 250g', quantity: 4, unit: 'Bungkus', price: 4500, subtotal: 18000 },
    ],
    subtotal: 69000,
    discount: 0,
    total: 69000,
  ...
  },
  {
    id: 'TRX-004',
    items: [
      { productId: '7', productName: 'Kecap Manis ABC 600ml', quantity: 2, unit: 'Botol', price: 18000, subtotal: 36000 },
      { productId: '10', productName: 'Sambal ABC Extra Pedas 135ml', quantity: 1, unit: 'Botol', price: 9500, subtotal: 9500 },
    ],
    subtotal: 45500,
    discount: 0,
    total: 45500,
  ...
  },
  {
    id: 'TRX-005',
    items: [
      { productId: '4', productName: 'Indomie Goreng', quantity: 10, unit: 'Pcs', price: 3500, subtotal: 35000 },
      { productId: '8', productName: 'Susu Indomilk 1L', quantity: 2, unit: 'Kotak', price: 19000, subtotal: 38000 },
    ],
    subtotal: 73000,
    discount: 3000,
    total: 70000,
...
export const purchases: Purchase[] = [
  {
    ...
    items: [
      { productId: '4', productName: 'Indomie Goreng', quantity: 5, unit: 'Dus', price: 112000, subtotal: 560000 },
      { productId: '5', productName: 'Kopi Kapal Api Special 165g', quantity: 2, unit: 'Dus', price: 190000, subtotal: 380000 },
    ],
    totalAmount: 940000,
    paidAmount: 940000,
    status: 'paid',
  ...
  },
  {
    id: 'PO-002',
    supplierId: '3',
    supplierName: 'UD Maju Jaya',
    items: [
      { productId: '1', productName: 'Beras Premium 5kg', quantity: 20, unit: 'Karung', price: 62000, subtotal: 1240000 },
      { productId: '3', productName: 'Gula Pasir 1kg', quantity: 1, unit: 'Karung', price: 700000, subtotal: 700000 },
    ],
    totalAmount: 1940000,
    paidAmount: 1000000,
    status: 'partial',
  ...
  },
  {
    id: 'PO-003',
    supplierId: '4',
    supplierName: 'PT Unilever Indonesia',
    items: [
      { productId: '6', productName: 'Detergen Rinso 800g', quantity: 3, unit: 'Dus', price: 144000, subtotal: 432000 },
    ],
    totalAmount: 432000,
    paidAmount: 432000,
    status: 'paid',
...
export const topProducts = [
  ...
  { name: 'Minyak Goreng Bimoli 2L', sold: 95, revenue: 3040000 },
  { name: 'Gula Pasir 1kg', sold: 88, revenue: 1408000 },
  { name: 'Kopi Kapal Api Special 165g', sold: 75, revenue: 900000 },
];
